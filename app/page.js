   ...
   <section className="mx-auto max-w-screen-xl px-4 items-center grid justify-items-center lg:flex md:px-8">
    <div className="space-y-4 flex-1 sm:text-center lg:text-left">
     <h1 className="text-primaria font-bold text-5xl xl:text-7xl">
      <span className="text-terceira">A</span> plataforma <span className="text-terceira">onde nossa</span> arte <span className="text-terceira">é a sua</span> beleza
     </h1>
    ...
    <div className="flex-1 text-center mt-7 lg:mt-0 lg:ml-3 max-w-md">
     <Image
      src={MulherFlorNago}
      className="w-full mx-auto sm:w-10/12 lg:w-full rounded-full text-white  "
     />
    </div>
   </section>
  </div>
