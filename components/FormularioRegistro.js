...
export default function FormularioRegistro() {
  ...
  function onSubmit(event) {
    ...
    console.log(isProfessional, formularioRegistro)
  }
        ...
        <>
          ...
          <div className="col-span-6 grid">
            <ul className="mt-6 space-y-3">
              <p className="block text-sm font-medium text-segunda text-center">Seus segmentos</p>
                ...
                <li key={index}>
                  <label htmlFor={item.name} className="block relative">
                    <input
                      ...
                      onChange={(e) => {
                        if (!e.target.checked) return setFormularioRegistro((valoresAnterior) => {
                          return {...valoresAnterior, ["segmento"]: valoresAnterior.segmento.filter((elemento) => elemento !== item)}
                        })

                        setFormularioRegistro((valoresAnterior) => {
                          return {...valoresAnterior, ["segmento"]: [...valoresAnterior.segmento, item]}
                        })
                      }}
                    />
